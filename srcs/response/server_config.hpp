...
class ServerConfig {
 public:
  // @fyuta: uriを渡すとroot/location
  // configをベースにproxyとかをたどって本当に開くべきファイルパスを返してくれる関数を実装してもらえませんでしょうか
  ...
  */
  ...
  size_t
      client_max_body_size_;  // @fyuta:
                              // ConfigParserの方で数字に読み替えてもらえるとありがたいです。intで収まり切るかどうかは要検討
